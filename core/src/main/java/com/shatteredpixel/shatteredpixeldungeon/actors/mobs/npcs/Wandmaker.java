...
public class Wandmaker extends NPC {
	...
	public boolean interact(Char c) {
		...
		final String narrativeGreet = NarrativeDirector.greetNpc(NpcKind.WANDMAKER);
		if (narrativeGreet != null) {
			Game.runOnRenderThread(new Callback() {
				@Override public void call() {
					com.watabou.noosa.Image p = null;
					try { p = new com.watabou.noosa.Image("narrative/wandmaker_portrait.png"); } catch (Exception ignored) {}
